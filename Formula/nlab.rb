class Nlab < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/nLabs-nScope/nLab/releases/download/2.0.0/nLab-darwin-arm64-2.0.0.zip"
      sha256 "f8c44ec5a71e01e087b6772f9bd8d80753c1652018f17c8b0241bf7ae4cec973"
    else
      url "https://github.com/nLabs-nScope/nLab/releases/download/2.0.0/nLab-darwin-x64-2.0.0.zip"
      sha256 "f8c44ec5a71e01e087b6772f9bd8d80753c1652018f17c8b0241bf7ae4cec973"
    end
  end
